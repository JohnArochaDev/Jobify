					...
					<Col style={{ display: 'flex', alignItems: 'center' }}>
							<Form>
									<InputGroup className="mb-3">
										<Form.Control type="text" placeholder="Search Jobs" id="jobSearch" onChange={e => setQuery(e.target.value)} />
										<Form.Control type="text" placeholder="Location" id="locationSearch" onChange={e => setLocation(e.target.value)} />
